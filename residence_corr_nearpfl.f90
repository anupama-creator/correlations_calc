...
!=================================================================================
       ...
       integer :: nstep
       integer :: t
       real(kind=8) :: sum_sq_dis,sum_4_dis,dt
...
!     do ja=1,natom_PFL
   !    if (im.ne.jm) then
! any of the labeled oxygen can be close to OW
      if(adjustl(atnm_rPFL(jm,7))=="O1") then !.or.adjustl(atnm_rPFL(jm,ja))=="O2")then
      ...
      !enddo
              enddo PG            ! for the reason we are looking water near pfl
...
!===============================================================================
                ...
                enddo
                write(4,1011) (real(i)*dt,(res_corr(i)/res_corr(0)),i=0,fr_end-fr_start)! *0.001*100
